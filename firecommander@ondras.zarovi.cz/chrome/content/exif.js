...
EXIF.NAMES[0x8769][0xA005] = EXIF.NAMES; /* exif interopindex -> tiff ifd :) */

/**
 * Vrátí seznam přítomných tagů
 */
EXIF.prototype.getTags = function() {
	return this._tags;
}
...
EXIF.prototype._readEXIF = function(start, length) {
	var str = "Exif";
	...
	this._readIFD(tiffStart+firstOffset, tiffStart, EXIF.NAMES);
}

EXIF.prototype._readIFD = function(ifdStart, tiffStart, names) {
...
EXIF.prototype._readTagValue = function(tagStart, tiffStart) {
...
EXIF.prototype._setBigEndian = function(bigEndian) {
	this._bigEndian = bigEndian;
}

EXIF.prototype._getValue = function(index, length) {
	this._is.seek(this._is.NS_SEEK_SET, index);
	var len = length || 1;
	var result = 0;
